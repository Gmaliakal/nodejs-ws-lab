...
class GameScene extends Phaser.Scene {
  ...
  /* copied the update function from the finished repo as I was having problems with mine
     source: https://github.com/uofa-cmput404/nodejs-ws-lab/blob/finishedLab/client.ts
     author : awwong1 */
